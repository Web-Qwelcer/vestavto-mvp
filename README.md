...
Цей проєкт розроблено з використанням AI-assisted development:

- **Claude (Anthropic)** — архітектура, код, дебаг
- **Dual-workflow:** Opus (планування) + Sonnet (виконання)

~5,500 рядків коду за 3 дні розробки.

### Що робив AI:
- Генерація boilerplate коду
- Реалізація API endpoints
- React компоненти
- Інтеграції (Monobank, Nova Poshta)
- Дебаг і виправлення помилок

### Що робив розробник:
- Архітектурні рішення
- Бізнес-логіка і флоу
- Тестування на реальних сценаріях
- Product decisions
- Code review і фінальні рішення

AI — це інструмент, не заміна розробника. 🛠️
